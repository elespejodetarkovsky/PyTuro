...
urlpatterns = [
    ...
    path('cursos/', portfolioViews.cursos, name="cursos"),
    path('inscripciones/', portfolioViews.inscripciones, name = "inscripciones"),
    path('coockies/', coreViews.coockie, name="coockie"),
